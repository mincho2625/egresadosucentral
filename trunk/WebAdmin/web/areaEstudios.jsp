                        ...
                        <div class="row">
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 center-block">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                    <div id="div2">
                                        <table rules="all" class="table table-striped table-bordered tabla_verde" style="width: 600px;">
                                            <thead>
                                                <tr>
                                                    <th>Nombre</th>
                                            ...
                                            <tbody>
                                                ...
                                                <s:iterator value="listaObjetos">
                                                    <tr>
                                                        ...
                                                        <td><s:property value="idNivelEstudios.nombre"></s:property></td>
                                                            <td>
                                                                <div class="fuentetabla2">
                                                                <s:url id="editarURL" action="editarAreaEstudios.action">
                                                                    <s:param name="idObjeto" value="%{idAreaEstudios}" ></s:param>
                                                                </s:url>
                                                                <s:a href="%{editarURL}">
                                                ...
                                                <s:push value="objeto">
                                                    <s:hidden name="idAreaEstudios"></s:hidden>
                                                        <table style="margin-left: 50px;width: 300px">
                                                            ...
                                                            <tr>
                                                                <td></td>
                                                            <td><s:submit cssClass="boton_auxiliar boton" value="Guardar"></s:submit></td>
                                                        </tr>
                                                    </table>
                                                </s:push>
                                            </s:form>
