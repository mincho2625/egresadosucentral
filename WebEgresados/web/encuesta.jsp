        ...
        <div class="encuesta" id="contenido1">
            <s:form action="guardarEncuesta.action" method="post">
                <s:hidden name="orden"></s:hidden>
                    ...
                    <div class="enlaces">
                    <s:if test="orden > 1">
                        <div class="tdatras"><a href="anteriorEncuesta.action" class="tdatras"><img src="imagenes/atras.jpg" width="24" height="24"></a></div>
                    </s:if>
                    <div class="tdsiguiente"><a href="siguienteEncuesta.action"><img src="imagenes/next.png" width="24" height="24"></a></div>
                </div>
            </s:form>
        </div>
    </body>
