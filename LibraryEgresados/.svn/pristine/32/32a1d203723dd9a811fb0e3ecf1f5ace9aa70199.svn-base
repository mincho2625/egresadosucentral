...
@NamedQueries({
    ...
    @NamedQuery(name = "LenguaExtranjera.findByIdEgresado", 
            query = "SELECT a FROM LenguaExtranjera a "
...
public class LenguaExtranjera implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return (this.idLenguaExtranjera != null || other.idLenguaExtranjera == null) && (this.idLenguaExtranjera == null || this.idLenguaExtranjera.equals(other.idLenguaExtranjera));
    }
