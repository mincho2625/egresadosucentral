                ...
                <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 hidden-xs">
                    <div class="custom"  >
                        <div class="search pull-right">
                            <h3 style="color: #B11F16">Portal Administrativo Egresados Universidad Central</h3>
                        </div>
                    </div>
                </div>    
            </div>
        </header>   
        <div id="main" class="container" role="main" style="height: 400px;">
            <div class="row">
                <aside>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-11">
                        <div>
                            <div class="menuPrincipal center-block ">
                                ...
                                <div class="menu">
                                    <p style="text-align: justify;font-weight: bold;">¡Bienvenido al Sistema de egresados universidad)!          </p>
                                    <p style="text-align: justify;font-weight: bold;">MODULO ADMINISTRADOR</p>
                                </div>
                                </div> 
                            </div>
                        </div>
                        <div class="componente col-lg-9 col-md-9 col-sm-8 col-xs-9  center-block">
                            <div class="from">
                                ...
                                <div id="contenido" class="menu">
                                    <div>
                                    <h2 style="text-align: center;color: #1A171B">Iniciar Sesion</h2>
                                    <s:actionerror cssClass="alert alert-danger"></s:actionerror>
                                    <s:form name="f1" method="post" action="Ingreso" id="Ingreso">
                                        <table style="margin-left: 130px;border:hidden;text-align:center;width:300px;font-size:14px; color: #666;" class="">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                        <s:password name="contrasenia" id="contrasenia" label="Contraseña" errorPosition="bottom"></s:password>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td/>
                                                        <td>
                                                        <s:submit cssClass="boton_auxiliar boton guardar" cssStyle="width:auto;" value="ENTRAR" id="Ingreso_0"></s:submit>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
