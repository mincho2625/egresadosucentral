                                    ...
                                    <div id="div6" >
                                        <s:form cssStyle="margin-left: 100px">
                                            <display:table class="table table-striped table-bordered tabla_verde" style="width: 400px"
                                                           name="listaObjetos" pagesize="5" cellspacing="5px;"  cellpadding="5px;" uid="row" requestURI="/obtenerListaIntensidadHoraria.action">
                                                ...
                                                <display:column title="Acción">
                                                    <s:url id="editarURL" action="editarIntensidadHoraria.action">
                                                        <s:param name="idObjeto" value="%{#attr.row.idIntensidadHoraria}" ></s:param>
                                                    </s:url>
                                                    <s:a href="%{editarURL}">
