...
public class Excel2007ExportView implements BinaryExportView {
    ...
    public void setParameters(TableModel tableModel, boolean exportFullList, boolean includeHeader,
        ...
        System.out.println("Model: " + this.model.getRowListFull());
    ...
    protected void generateXLSXTable() throws JspException, BadElementException {
        //adding caption
        if (this.model.getCaption() != null && !"".equals(this.model.getCaption())) {
        ...
        //adding footer
        if (this.model.getFooter() != null && !"".equals(this.model.getFooter())) {
            Row blankrow = sheet.createRow(rowCount++);
            Row blankrow2 = sheet.createRow(rowCount++);
            Row row = sheet.createRow(rowCount++);
