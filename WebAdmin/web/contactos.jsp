                    ...
                    <div class="componente col-lg-11 col-md-11 col-sm-11 col-xs-11 center-block">
                        <div class="row" style="margin-left: 100px">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                                <h1 style="margin-left: 70px;color: #2a6155;width:300px">Consulta de contactos</h1>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div id="div6" style="margin-left: 40px">
                                        <s:form>
                                            <display:table class="table table-striped table-bordered tabla_verde " style="width: 600px;height: auto" export="true"
                                                           name="listaObjetos" pagesize="5" cellspacing="5px;"  cellpadding="5px;" uid="row" requestURI="/generarListaContactos.action">

                                                <display:column property="idTipoContacto.nombre" title="Tipo Contacto" sortable="true"/>
                                                ...
                                                <display:setProperty name="export.csv.filename" value="Contactos.csv" />
                                                <display:setProperty name="export.excel.filename" value="Contactos.xlsx" />
                                                <display:setProperty name="export.xml.filename" value="Contactos.xml" />
                                                <display:setProperty name="export.pdf.filename" value="Contactos.pdf" />
                                            </display:table>
                                        </s:form>
                                    </div>          
                                    <br>            
