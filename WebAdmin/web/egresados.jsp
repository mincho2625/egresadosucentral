                        ...
                        <jq:accordion id="accordion" animate="true" collapsible="true" active="%{#indice}">
                            <jq:accordionItem title="Criterios de búsqueda">
                                <div class="row" class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
                                    <s:form action="buscarEgresados.action" id="formCorreo">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                ...
                                                <jq:select cssStyle="width: 100px;" href="%{busquedaAvanzadaURL}" name="seleccionNivelEstudios" id="seleccionNivelEstudios"
                                                ...
                                                <jq:select cssStyle="width: 100px;" href="%{busquedaAvanzadaURL}" label="Año Finalización" errorPosition="bottom" name="seleccionAnios" list="listaAnios" 
                                                ...
                                                <jq:select cssStyle="width: 100px;" href="%{busquedaAvanzadaURL}" label="Género" errorPosition="bottom" name="seleccionGeneros" list="listaGeneros" multiple="true"
                                                           id="seleccionGeneros" onCompleteTopics="reloadCriteria" onChangeTopics="reloadCriteria" formIds="formCorreo"></jq:select>


                                                <jq:select cssStyle="width: 100px;" href="%{busquedaAvanzadaURL}" label="Columnas" errorPosition="bottom" name="seleccionIdColumnas" 
                                                ...
                                                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                                    <br>
                                                <jq:select href="%{busquedaAvanzadaURL}" onChangeTopics="reloadThirdlist,reloadCriteria" name="seleccionFacultades" id="seleccionFacultades"
                                                ...
                                                <jq:select href="%{busquedaAvanzadaURL}" reloadTopics="reloadThirdlist" label="Programa" errorPosition="bottom"
                                                ...
                                                <jq:select href="%{busquedaAvanzadaURL}" label="Estado Civil" errorPosition="bottom" name="seleccionEstadosCiviles" list="listaEstadosCiviles" 
                                        ...
                                        <div style="margin-left: -35px" class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                            ...
                                            <jq:select href="%{busquedaAvanzadaURL}" label="Columnas Seleccionadas" readonly="true" formIds="formCorreo" multiple="true" 
