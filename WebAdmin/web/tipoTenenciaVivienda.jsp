                    ...
                    <div class="componente col-lg-11 col-md-11 col-sm-11 col-xs-11 center-block">
                        <div class="row" style="margin-left: 150px">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                                <h1 style="margin-left: 70px;color: #2a6155;width:300px">Tipos Tenencia <br> Vivienda</h1>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 center-block">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                    <div id="div6" >
                                        <s:form cssStyle="margin-left: 100px">
                                            <display:table class="table table-striped table-bordered tabla_verde" style="width: 400px"
                                                           name="listaObjetos" pagesize="5" cellspacing="5px;"  cellpadding="5px;" uid="row" requestURI="/obtenerListaTipoTenenciaVivienda.action">
                                                <display:column property="nombre" title="Nombre" sortable="true"/>
                                                <display:column title="Acción">
                                                    <s:url id="editarURL" action="editarTipoTenenciaVivienda.action">
                                                                    <s:param name="idObjeto" value="%{#attr.row.idTipoTenenciaVivienda}" ></s:param>
                                                                </s:url>
                                                                <s:a href="%{editarURL}">
                                                                    <img style="width: 20px; height: 19px;" title="Editar" alt="Editar" src="imagenes/editar-icono-8419-16.png" align="top">
                                                                </s:a>
                                                                <s:url id="borrarURL" action="borrarTipoTenenciaVivienda.action">
                                                                    <s:param name="idObjeto" value="%{#attr.row.idTipoTenenciaVivienda}"></s:param>
                                                                </s:url>
                                                                <s:a href="%{borrarURL}">
                                    ...
                                    <div class="fromtables" style="margin-left: 200px; width: 200px">
                                        <a href="crearTipoTenenciaVivienda.action" target="contenido">
                                    ...
                                    <div class="fromtables" id="contenido1" style="margin-left: 100px">
                                        <s:if test="editar">
                                            ...
                                            <s:form action="guardarTipoTenenciaVivienda.action">
                                                <s:push value="objeto">
                                                    <s:hidden name="idTipoTenenciaVivienda"></s:hidden>
